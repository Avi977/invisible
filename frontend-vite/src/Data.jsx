...
export const TERM_CONTEXT = {
  "invisible · dashboard": {
    ...
    projectId: "invisible",
    color: "#f5b343",
    goal: "Keep Envy pointed at the real local checkout and verify the dashboard.",
    activity: [
      { t: "now", k: "ok",   c: "Graphify and Relations use configured repo_path first" },
      { t: "now", k: "ok",   c: "Terminal fallback panes use local Windows repos" },
      { t: "now", k: "warn", c: "Run gstack after focused tests" },
      { t: "now", k: "ok",   c: "PowerShell paths preserved in pane prompts" },
    ],
    next: [
      "Run focused pytest coverage for Graphify and Relations",
      "Run gstack and fix any surfaced app issues",
  ...
  "hot-tyres · web": {
    ...
    projectId: "hot-tyres",
    color: "#5cc8ff",
    goal: "Keep a local PowerShell pane ready for the tyre site repo.",
    activity: [
      { t: "now", k: "ok",   c: "Pane cwd points at C:\\Users\\mahar\\repos\\hot-tyres" },
      { t: "now", k: "ok",   c: "PowerShell command history is Windows-native" },
      { t: "now", k: "ok",   c: "Fallback data avoids unrelated sample projects" },
    ],
    next: [
      "Run repo tests when this pane is selected",
      "Use live PTY output when the daemon is connected",
      "Keep fallback content project-specific",
    ],
  },
  "roofing-sydney · site": {
    project: "Roofing Sydney",
    projectId: "roofing-sydney",
    color: "#b794ff",
    goal: "Keep the roofing.sydney local site pane ready for builds.",
    activity: [
      { t: "now", k: "ok",   c: "Pane cwd points at C:\\Users\\mahar\\repos\\roofing.sydney" },
      { t: "now", k: "ok",   c: "Build command shown as a local PowerShell workflow" },
      { t: "now", k: "ok",   c: "No Mac or mobile simulator fallback copy remains here" },
    ],
    next: [
      "Run corepack pnpm build",
      "Check git status",
      "Use Envy handoff for repeated validation",
    ],
  },
  "moana · workspace": {
    project: "Moana",
    projectId: "moana",
    color: "#4ade80",
    goal: "Keep the Moana workspace available from a Windows local pane.",
    activity: [
      { t: "now", k: "ok",   c: "Pane cwd points at C:\\Users\\mahar\\repos\\Moana" },
      { t: "now", k: "ok",   c: "PowerShell Get-Location output shown" },
      { t: "now", k: "ok",   c: "Context header mirrors the fallback pane" },
    ],
    next: [
      "Inspect repo status",
      "Run the project-specific test command",
      "Switch to live PTY output when available",
    ],
  },
  "claude-workflow-portable · tools": {
    project: "Claude Workflow Portable",
    projectId: "claude-workflow-portable",
    color: "#f56fb1",
    goal: "Keep the workflow tooling repo visible without sample project noise.",
    activity: [
      { t: "now", k: "ok",   c: "Pane cwd points at C:\\Users\\mahar\\repos\\claude-workflow-portable" },
      { t: "now", k: "ok",   c: "Skills folder command is local and Windows-safe" },
      { t: "now", k: "ok",   c: "Git status prompt is ready" },
    ],
    next: [
      "Inspect available workflow skills",
      "Check local changes",
      "Keep command examples PowerShell-native",
    ],
  },
  "system · envy": {
    project: "System",
    projectId: "system",
    color: "#5ee0c8",
    goal: "Keep a system pane ready for Envy config and validation commands.",
    activity: [
      { t: "now", k: "ok",   c: "Reads INVISIBLE_HOME\\invisible.toml" },
      { t: "now", k: "ok",   c: "Shows configured local project list" },
      { t: "now", k: "warn", c: "gstack is part of final app verification" },
    ],
    next: [
      "Run gstack from the invisible checkout",
      "Fix any app issues it reports",
      "Keep final verification output short and actionable",
    ],
  },
};
